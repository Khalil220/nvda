...
* When an application's UI Automation provider is slow to answer, NVDA now recovers from the resulting freeze rather than waiting for UI Automation's own timeout to expire. (#20654, @Khalil220)
